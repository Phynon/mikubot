...
class Music_api():
    ...
    def search(self, s, offset, type='1'):
        ...
        params = self.aesEncrypt(self.aesEncrypt(text, self.nonce),
                                 self.secKey)
    ...
    def get_music_list(self, keywords):
        ...
        for offset in range(1):
            ...
            for music in result:
                ...
                if (music['privilege']['fee'] == 0
                        or music['privilege']['payed']) and music['privilege'][
                            'pl'] > 0 and music['privilege']['dl'] == 0:
                    continue
                if music['privilege']['dl'] == 0 and music['privilege'][
                        'pl'] == 0:
                    continue
                # if music['fee'] == 8:
